...
class AttendingsControllerTest < ActionController::TestCase
  ...
  test "should create attending" do
    assert_difference('Attending.count') do
      post :create, attending: { email: @attending.email, first_name: @attending.first_name, last_name: @attending.last_name }
    end
  ...
  test "should update attending" do
    patch :update, id: @attending, attending: { email: @attending.email, first_name: @attending.first_name, last_name: @attending.last_name }
    assert_redirected_to attending_path(assigns(:attending))
  end
